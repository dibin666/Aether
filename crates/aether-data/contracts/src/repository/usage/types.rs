...
pub struct StoredProviderApiKeyWindowUsageSummary {
    ...
    pub p95_first_byte_time_ms: Option<u64>,
    pub avg_response_time_ms: Option<f64>,
    pub p50_response_time_ms: Option<u64>,
    pub p95_response_time_ms: Option<u64>,
    pub last_used_at_unix_secs: Option<u64>,
    pub model_request_counts: std::collections::BTreeMap<String, u64>,
    pub error_request_counts: std::collections::BTreeMap<String, u64>,
}
