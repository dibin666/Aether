...
export const adminRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'QuotaCountdown',
        component: view(() => import('@/views/admin/QuotaCountdown.vue'))
      },
      {
        path: 'pool-consumption',
        name: 'PoolConsumptionStats',
        component: view(() => import('@/views/admin/PoolConsumptionStats.vue'))
      },
      {
        path: 'models',
